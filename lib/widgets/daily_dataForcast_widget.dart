...
import 'package:weather_app_getx/model/weather_data_daily.dart';
import 'package:weather_app_getx/utils/custom_colors.dart';

class DialyDataForCast extends StatelessWidget {
  final WeatherDataDaily weatherDataDaily;
  const DialyDataForCast({super.key, required this.weatherDataDaily});
